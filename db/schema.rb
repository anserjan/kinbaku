...
ActiveRecord::Schema[7.0].define(version: 2024_02_28_012500) do
  ...
  create_table "ckeditor_assets", force: :cascade do |t|
    ...
    t.string "kind_of", limit: 30
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["kind_of"], name: "index_ckeditor_assets_on_kind_of"
  end
  ...
  create_table "spree_deposits", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "spree_participants", force: :cascade do |t|
    t.integer "product_id"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.boolean "course_confirmed", default: false
